...
const table_ecomm_memb_ok = 'membersukses';

const MemberSukses = sequelize.define('ecomm_memb_ok', {
...
}, {freezeTableName: true, timestamps: false, hasTrigger: true, table_ecomm_memb_ok });


module.exports = MemberSukses;