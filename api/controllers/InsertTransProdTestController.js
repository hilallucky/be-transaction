...
const InsertTransProdTestController = () => {

"use strict";
  const insertTransProdTest = async (req, res) => {
    let { body } = req;
...
//startinsert into table production from _sgo
  ...
  const insertTransProdTestFromTemp = async (req, res) => {
    let { body } = req;
            ...
            for (var x = 0; x < datahdr[0].length; x++) {
              console.log('orderno = ' + datahdr[0][x].orderno);
                ...
                headerProd.push({
                              ...
                              bonusmonth : datahdr[0][x].bonusmonth,
                              ...
                              print_date : datahdr[0][x].print_date,
...
module.exports = InsertTransProdTestController;
